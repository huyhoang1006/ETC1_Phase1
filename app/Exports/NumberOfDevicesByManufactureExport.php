...
class NumberOfDevicesByManufactureExport implements FromView, WithEvents
{
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $event->sheet->mergeCells('A3:E3')->getCell('A3')->setValue('Báo cáo thống kê số lượng thiết bị của từng hãng sản xuất');
    ...
    public function view(): View
    {
        ...
        $result = numberOfDevicesByManufactureData($request);
        if (!empty($result['error'])) {
            return view('report::numberOfDevicesByManufactureReport.export', [
                'error' => $result['error']
            ]);
        }
