...
@section('pageTitle', 'PXCĐ - Báo cáo thống kê cáp và dây dẫn đã thí nghiệm - Báo cáo theo thời gian - Báo cáo theo tháng')
    ...
    <div>
        <div class="row dashboard-index detail-report" style="padding-top: 0;">
            <div class="col-lg-12 col-xl-12">
                <h4 class="m-b-30">Báo cáo thống kê cáp và dây dẫn đã thí nghiệm - Báo cáo theo thời gian - Báo cáo theo tháng</h4>
            </div>
            <div class="col-lg-12">
                <div class=" m-b-30">
                    <div class="card m-b-30">
                        ...
                        <form class="form card-body module_search" style="align-items: flex-end">
                            <div class="form-group form_input form_date">
                                ...
                                <input type="month" class="form-control" name="time" value="{{ date('Y-m') }}" />
                            </div>
