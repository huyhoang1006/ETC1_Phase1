...
@section('content')
    <div class="row dashboard-index detail-report" style="padding-top: 0px">
        <div class="col-lg-12 col-xl-12">
            <h4 class="m-b-30">Báo cáo thống kê cáp và dây dẫn đã thí nghiệm - Báo cáo theo nhà cung cấp - Báo cáo theo doanh số và chất lượng nhà cung cấp</h4>
        </div>
            ...
            <div class="card m-b-30">
                ...
                <form class="card-body module_search" style="padding-top: 15px;padding-bottom: 20px;">
                    ...
                    <div class="form-group form_input">
                        <p>Hãng sản xuất</p>
                        <select class="select2-single form-control" name="manufacturer[]" multiple="multiple" id="element">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $(".btn-export__dl5").on("click", function() {
                ...
                $.ajax({
                    type: "post",
                    url: "{{route('admin.exportSupplierQualityReport')}}",
                    data: {_token:token, year_from:year_from, year_to:year_to, filter_type:filter_type},
                    dataType: "JSON",
