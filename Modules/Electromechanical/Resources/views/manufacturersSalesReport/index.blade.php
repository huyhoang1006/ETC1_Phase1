...
@section('pageTitle', 'PXCĐ - Báo cáo thống kê cáp và dây dẫn đã thí nghiệm - Báo cáo theo nhà cung cấp - Báo cáo doanh số giữa các nhà sản xuất')
    ...
    <div>
        <div class="row dashboard-index detail-report" style="padding-top: 0;">
            <div class="col-lg-12 col-xl-12">
                <h4 class="m-b-30">Báo cáo thống kê cáp và dây dẫn đã thí nghiệm - Báo cáo theo nhà cung cấp - Báo cáo doanh số giữa các nhà sản xuất</h4>
            </div>
            <div class="col-lg-12">
                <div class=" m-b-30">
...
@push('scripts')
    <script>
        $('.module_search').submit(function(e){
            ...
            $.ajax({
                url: '{{ route('admin.manufacturersSalesReportPreview') }}',
                type: 'POST',
                dataType: 'html',
                data: $(this).serialize()
