...
@section('pageTitle', 'PXCĐ - Báo cáo thống kê cáp và dây dẫn đã thí nghiệm - Báo cáo theo nhà cung cấp - Báo cáo so sánh chất lượng nhà cung cấp')
...
@section('content')
    <div>
        <div class="row dashboard-index detail-report" style="padding-top: 0;">
            <div class="col-lg-12">
                <h4 class="m-b-30">
                    Báo cáo thống kê cáp và dây dẫn đã thí nghiệm - Báo cáo theo nhà cung cấp - Báo cáo so sánh chất lượng nhà cung cấp
                </h4>
            </div>
            <div class="col-lg-12">
                <div class=" m-b-30">
                    <div class="card m-b-30">
                        ...
                        <form class="form card-body module_search" style="align-items: flex-end">
                            <div class="form-group form_input form_date">
                                <p>Năm bắt đầu</p>
                                <select class="select2-single form-control" name="start_year" id="start_year">
                            ...
                            <div class="form-group form_input form_date">
                                <p>Năm kết thúc</p>
                                <select class="select2-single form-control" name="end_year" id="end_year">
                                    @for ($i = date('Y'); $i >= 2015; $i--)
                                        <option value="{{ $i }}">{{ $i }}</option>
                                    @endfor
                                </select>
...
@push('scripts')
    <script>
        $('.btn-eport-cd7').on('click', function(){
            ...
            $.ajax({
                url: "{{ route('admin.supplierQualityExport') }}",
                type: 'POST',
                dataType: 'JSON',
                data: {
                    _token: "{{ csrf_token() }}",
