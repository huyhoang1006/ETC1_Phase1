...
@section('pageTitle', 'PXCĐ - Báo cáo thí nghiệm nhất thứ - Máy cắt - Báo cáo hạng mục thí nghiệm không đạt theo hãng sản xuất')
...
@section('content')
    <div>
        <div class="row dashboard-index detail-report" style="padding-top: 0;">
            <div class="col-lg-12">
                <h4 class="m-b-30">
                    Báo cáo thí nghiệm nhất thứ - Máy biến dòng điện - Báo cáo hạng mục thí nghiệm không đạt theo hãng sản xuất
                </h4>
            </div>
            <div class="col-lg-12">
                <div class=" m-b-30">
...
@push('scripts')
    <script>
        $('.btn-eport-cd7').on('click', function(){
            ...
            $.ajax({
                url: "{{ route('admin.cuttingTranferMachineCategoryComparisonExport') }}",
                type: 'POST',
                dataType: 'JSON',
                data: {
                    _token: "{{ csrf_token() }}",
