...
@section('pageTitle', 'PXCĐ - Báo cáo thí nghiệm thiết bị lẻ - Báo cáo thí nghiệm ' . (!empty($type) ? $type : $class))
    ...
    <div>
        <div class="row dashboard-index detail-report" style="padding-top: 0;">
            <div class="col-lg-12 col-xl-12">
                <h4 class="m-b-30">Báo cáo thí nghiệm thiết bị lẻ - Báo cáo thí nghiệm {{ !empty($type) ? $type : $class }}</h4>
            </div>
            <div class="col-lg-12">
                <div class=" m-b-30">
...
@push('scripts')
    <script>
        $('.module_search').submit(function(e){
            ...
            $.ajax({
                url: '{{ route('admin.deviceTestReportPreview', ['class' => $class, 'type' => !empty($type) ? $type : null]) }}',
                type: 'POST',
                dataType: 'html',
                data: $(this).serialize()
