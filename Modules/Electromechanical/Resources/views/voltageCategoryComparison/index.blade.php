...
@section('pageTitle', 'PXCĐ - Báo cáo thí nghiệm nhất thứ - Máy biến điện áp - Báo cáo hạng mục thí nghiệm không đạt theo hãng sản xuất')
...
@section('content')
    <div>
        <div class="row dashboard-index detail-report" style="padding-top: 0;">
            <div class="col-lg-12">
                <h4 class="m-b-30">
                    Báo cáo thí nghiệm nhất thứ - Máy biến điện áp - Báo cáo hạng mục thí nghiệm không đạt theo hãng sản xuất
                </h4>
            </div>
            <div class="col-lg-12">
                <div class=" m-b-30">
                    <div class="card m-b-30">
                        ...
                        <form class="form card-body module_search" style="align-items: flex-end">
                            ...
                            <div class="form-group form_input">
                                <p>Hãng sản xuất</p>
                                <select class="select2-single form-control" name="manufacturer[]" id="manufacturer" multiple>
...
@push('scripts')
    <script>
        $('.btn-eport-cd7').on('click', function(){
            ...
            $.ajax({
                url: "{{ route('admin.voltageCategoryComparisonExport') }}",
                type: 'POST',
                dataType: 'JSON',
                data: {
                    _token: "{{ csrf_token() }}",
