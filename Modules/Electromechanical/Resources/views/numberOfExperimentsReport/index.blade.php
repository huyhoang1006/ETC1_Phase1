...
@section('pageTitle', 'PXCĐ - Báo cáo thí nghiệm thiết bị lẻ - Báo cáo số lượng thí nghiệm trên từng loại thiết bị ')
    ...
    <div>
        <div class="row dashboard-index detail-report" style="padding-top: 0;">
            <div class="col-lg-12 col-xl-12">
                <h4 class="m-b-30">Báo cáo thí nghiệm thiết bị lẻ - Báo cáo số lượng thí nghiệm trên từng loại thiết bị </h4>
            </div>
            <div class="col-lg-12">
                <div class=" m-b-30">
                    <div class="card m-b-30">
                        ...
                        <form class="form card-body module_search" style="align-items: flex-end" action="{{ route('admin.numberOfExperimentsExport') }}" method="get">
...
@push('scripts')
    <script>
        $('#submitBtn').click(function(e){
            ...
            $.ajax({
                url: '{{ route('admin.numberOfExperimentsReportPreview') }}',
                type: 'POST',
                dataType: 'html',
