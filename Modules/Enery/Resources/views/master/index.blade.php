            ...
            <form class="card-body module_search" style=" padding-top: 15px;padding-bottom: 20px;" method="get" action="">
                ...
                @else
                    <div class="form-group form_input">
                        ...
                        <input type="text"  class="form-control" name="zTest_Run" value="{{ request()->get('zTest_Run') }}" />
                    </div>
                @endif
    ...
    <script>
        ...
        function gotoReport() {
            ...
            if (uniqueItems.length > 1) {
                ...
                window.location.href = '{{ $detail }}' + '?ids=' +  ids.join(',')+'&'+request;
            }
        }
