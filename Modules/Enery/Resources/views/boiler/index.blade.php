...
@section('content')
    <div class="row dashboard-index detail-report" style="padding-top: 0px">
        <div class="col-lg-12 col-xl-12">
            <h4 class="m-b-30">Quản lý báo cáo đánh giá hiệu suất nồi hơi công nghiệp tải dầu theo hãng sản xuất</h4>
        </div>
            ...
            <div class="card m-b-30">
                ...
                <form class="card-body module_search" style=" padding-top: 15px;padding-bottom: 20px;" method="get" action="{{ route('admin.boilersByManufacture') }}">
                    ...
                    <div class="form-group form_submit mb-0" style="display: flex;align-items: center;width: 300px;">
                        ...
                        <button id="btn-export" class="btn btn-dark {{ !empty($items) ? '' : 'button-hidden' }}" href="{{ route('admin.exportBoilersByManufacture', ['data' => $request]) }}" style="margin-left: 15px;">Xuất file</button>
                    </div>
                </form>
            </div>
            @if (!empty($items))
