...
<div class="row dashboard-index detail-report" style="padding-top: 0px">
    <div class="col-lg-12 col-xl-12">
        <h4 class="m-b-30">Quản lý báo cáo đánh giá độ không đảm bảo đo của thiết bị hiệu chuẩn áp suất</h4>
    </div>
    <div class="col-sm-12 col-xl-12">
        <div class="card m-b-30">
            ...
            <form class="card-body module_search" style=" padding-top: 15px;padding-bottom: 20px;" method="get" action="{{ route('admin.thiet_bi_hieu_chuan_ap_xuat') }}">
    ...
    <script>
        ...
        function gotoReport() {
            ...
            if (uniqueItems.length > 1) {
                ...
                window.location.href = '{{ route('admin.thiet_bi_hieu_chuan_ap_xuat_preview') }}?ids=' +  ids.join(',')+'&'+request;
            }
        }
