...
@section('pageTitle', 'Hóa dầu - Báo cáo thống kê thiết bị của từng hãng sản xuất')
    ...
    <div>
        <div class="row dashboard-index detail-report" style="padding-top: 0;">
            <div class="col-lg-12 col-xl-12">
                <h4 class="m-b-30">Báo cáo thống kê số lượng thiết bị của từng hãng sản xuất</h4>
            </div>
            <div class="col-lg-12">
                <div class=" m-b-30">
                    <div class="card m-b-30">
                        ...
                        <form class="form card-body module_search" style="align-items: flex-end" action="{{ route('admin.numberOfDevicesByManufactureReportExport') }}" method="get">
...
@push('scripts')
    <script>
        $('#submitBtn').click(function(e){
            ...
            $.ajax({
                url: '{{ route('admin.numberOfDevicesByManufactureReportPreview') }}',
                type: 'POST',
                dataType: 'html',
