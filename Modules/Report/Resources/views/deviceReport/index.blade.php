    ...
    <div>
        <div class="row dashboard-index detail-report" style="padding-top: 0;">
            <div class="col-lg-12 col-xl-12">
                <h4 class="m-b-30"> Báo cáo tỉ lệ theo số lượng thiết bị của từng hãng sản xuất ứng với năm hoặc khoảng thời gian sản xuất </h4>
            </div>
            <div class="col-lg-12">
                <div class=" m-b-30">
                    <div class="card m-b-30">
                        ...
                        <form class="form card-body module_search" style="align-items: flex-end">
                            <div class="form-group form_input form_date">
                                <p>Năm bắt đầu</p>
                                <input type="number" class="form-control" name="start_year" id="start_year" min="1970" value="">
                            </div>
                            <div class="form-group form_input form_date">
                                <p>Năm kết thúc</p>
                                <input type="number" class="form-control" name="end_year" id="end_year" min="1970" value="">
                            </div>
                            <div class="form-group form_input">
                                <p>Thiết bị</p>
                                <select class="select2-single form-control" name="device" id="device">
...
@push('scripts')
    <script>
        $('.btn-eport-cd7').on('click', function(){
            const startYear = $('#start_year').val();
            const endYear = $('#end_year').val();
            ...
            $.ajax({
                url: "{{ route('admin.deviceReportExport') }}",
                type: 'POST',
                dataType: 'JSON',
                data: {
                    _token: "{{ csrf_token() }}",
