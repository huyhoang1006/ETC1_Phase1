...
@section('content')
    ...
    <div class="row dashboard-index detail-report" style="padding-top: 0px" >
        <div class="col-lg-12 col-xl-12">
            <h4 class="m-b-30">Quản lý báo cáo phân tích kết quả phân tích khí hoà tan trong dầu cách điện</h4>
        </div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="{{ route('admin.report.export', ['id' => $item['id']]) }}" class="btn btn-primary">Xuất dữ liệu</a>
                            <a href="{{ route('admin.report.preview', ['id' => $item['id']]) }}" class="btn btn-primary">Preview</a>
                        </div>
                    </div>
                </div>
            </div>
