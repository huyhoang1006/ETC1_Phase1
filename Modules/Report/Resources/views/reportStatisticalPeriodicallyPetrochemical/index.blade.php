...
@section('pageTitle', 'Báo cáo thống kê - Phòng hóa dầu - Báo cáo thống kê kết quả thí nghiệm định kỳ')
    ...
    <div>
        <div class="row dashboard-index detail-report" style="padding-top: 0;">
            <div class="col-lg-12 col-xl-12">
                <h4 class="m-b-30"> Báo cáo thống kê kết quả thí nghiệm định kỳ </h4>
            </div>
            <div class="col-lg-12">
                <div class=" m-b-30">
...
@push('scripts')
    <script>
        $('.btn-eport').on('click', function(){
            ...
            $.ajax({
                url: "{{ route('admin.reportStatisticalPeriodicallyPetrochemicalExport') }}",
                type: 'POST',
                dataType: 'JSON',
                data: {
                    _token: "{{ csrf_token() }}",
