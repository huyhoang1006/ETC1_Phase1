            ...
            <div class="col-md-12">
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.machines') }}">Máy cắt</a></li>
                    </ol>
                </div>
            </div>
        </div>
...
@section('content')
    <div class="row dashboard-index detail-report" style="padding-top: 0px">
        <div class="col-lg-12 col-xl-12 mb-5 d-flex justify-content-between">
            <h4 class="text-dark">Báo cáo kiểm tra bên ngoài - máy cắt</h4>
            <form action="{{ route('admin.machines.export') }}" method="get">
