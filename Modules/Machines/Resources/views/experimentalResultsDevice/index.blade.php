                    ...
                    <div class="card m-b-30">
                        ...
                        <form class="form card-body module_search" style="align-items: flex-end">
                            <div class="form-group form_input">
                                ...
                                <input type="date" class="form-control date-from" name="startDate" id="startDate"/>
                            </div>
                            <div class="form-group form_input">
                                <p>Thời gian kết thúc</p>
                                <input type="date" class="form-control date-from" name="endDate" id="endDate" />
                            </div>
                            <div class="form-group form_input">
                                <p>Thiết bị</p>
                                <select class="select2-single form-control" name="devices[]" multiple>
                            ...
                            <div class="form-group form_input">
                                <p>Chủng loại</p>
                                <select class="select2-single form-control" name="deviceTypes[]" multiple="multiple"></select>
                            </div>
                            <div class="form-group form_input">
                                <p>Khu vực</p>
                            ...
                            <div class="form-group form_input">
                                <p>Đơn vị quản lý</p>
                                <select class="select2-single form-control" name="dvqls[]" multiple>
                            ...
                            <div class="form-group form_input">
                                <p>Quy trình thí nghiệm</p>
                                <select class="select2-single form-control" name="zqt">
                                    <option value="">Quy trình thí nghiệm</option>
                                    @foreach ($zQTs as $zqt)
                                        <option value="{{ $zqt['id'] }}">{{ $zqt['zsym'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group form_input">
                                <p>Hãng sản xuất</p>
                                <select class="select2-single form-control" name="manufacture_ids[]" multiple></select>
                            </div>
...
@push('scripts')
    <script>
        $('.module_search').submit(function(e){
            ...
            $.ajax({
                url: '{{ route('admin.experimentalResultsDeviceExport') }}',
                type: 'POST',
                dataType: 'html',
                data: $(this).serialize()
        ...
        $('select[name="devices[]"]').change(function(){
            ...
            $.ajax({
                ...
                if (typeof response['success'] !== 'undefined') {
                    ...
                    $('select[name="deviceTypes[]"]').html(html);
                }
            });
        });
    </script>
