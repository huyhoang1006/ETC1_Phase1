...
@section('pageTitle', 'Báo cáo phân tích - Phòng cao áp - Máy cắt - Thời gian tác động' )
            ...
            <div class="col-md-12">
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="javaScript:void();">Máy cắt</a></li>
                    </ol>
                </div>
            </div>
        </div>
...
<div class="row dashboard-index detail-report" style="padding-top: 0px">
    <div class="col-lg-12 col-xl-12 mb-5 d-flex justify-content-between">
        <h4 class="text-dark"> Báo cáo điện trở cách điện </h4>
