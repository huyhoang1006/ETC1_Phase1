...
@section('content')
    <div class="row dashboard-index detail-report" style="padding-top: 0px">
        <div class="col-lg-12 col-xl-12">
            <h4 class="m-b-30">Báo cáo dòng điện và tổn hao không tải</h4>
        </div>
        <div class="col-lg-12 col-xl-12" style="height: 100vh">
            <iframe src='https://view.officeapps.live.com/op/embed.aspx?src=http://telehouse.npcetc.paditech.org/demo/tonhao.xlsx' width='100%' height="100%" frameborder='0'> </iframe>
        </div>
    </div>
@endsection
