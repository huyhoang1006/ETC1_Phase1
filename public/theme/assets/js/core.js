...
$(document).ready(function() {
    ...
    /* -- Menu Scrollbar -- */
    /* -- show list -- */
    $(".widgetbar .show_list").on("click", function(e) {
        if ($(this).hasClass("list_tree")) {
          $(this).removeClass("list_tree");
          $(this).html('<i class="fa fa-tree mr-2"></i>Dạng cây');
        }
        else {
            $(this).addClass("list_tree");
            $(this).html('<i class="fa fa-list mr-2"></i>Dạng list');
        }
    });
    /* -- End show list -- */
