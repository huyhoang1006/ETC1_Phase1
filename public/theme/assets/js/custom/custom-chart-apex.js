...
$(document).ready(function() {
    ...
    xaxis: {
      ...
      categories: ['Đã thực hiện', 'Chưa thực hiện'],
      tickPlacement: 'on'
    },
    yaxis: {
      title: {
    ...
    var options = {
      series: [{
      name: 'Servings',
      data: [34, 55, 15, 65, 75, 40, 60, 85, 55, 25, 60, 40, 80]
    }],
      annotations: {
      points: [{
        x: 'Bananas',
    ...
    var chart = new ApexCharts(document.querySelector("#apex-column-chart2"), options);
    chart.render();
